...
/*   Updated: 2022/07/07 17:52:03 by lucas            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	*/
	...
	{
		reverse_iterator<Iterator>::iterator_type tmp(this->base_iterator);
		return *(--tmp);
	}
	...
	{
		return reverse_iterator<Iterator>(this->base_iterator - n);
	}
