...
int			main(void)
{
	...
	if (execute_tester("./Vector/ft_vec_test", std::to_string(seed))) return 1;
	if (execute_tester("./Vector/std_vec_test", std::to_string(seed))) return 1;
